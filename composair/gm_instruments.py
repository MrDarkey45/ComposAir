...
Source: General MIDI Level 1 instrument family list (standardized).
"""

from __future__ import annotations

GM_INSTRUMENT_NAMES: tuple[str, ...] = (
    # Piano (0-7)
...
def name_for(program: int) -> str:
    """Return the GM name for a program number, or a placeholder if out of range."""
    if 0 <= program <= 127:
